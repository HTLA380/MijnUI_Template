...
> = DistributiveMerge<
  ComponentProps,
  PermanentProps & { renderAs?: Component }
>;
...
> = Merge<
  React.ForwardRefExoticComponent<
    Merge<FastComponentPropsWithRef<Default>, Props & { renderAs?: Default }>
  >,
...
export type PolyRefFunction = <
  ...
  OnlyAs extends React.ElementType = React.ElementType,
>(
  Component: React.ForwardRefRenderFunction<any, Props & { renderAs?: OnlyAs }>,
) => PolyForwardComponent<Default, Props, OnlyAs>;
export const polymorphicForwardRef = React.forwardRef as PolyRefFunction;
