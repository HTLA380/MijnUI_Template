  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={applyUnstyled(
        isUnstyled,
        "flex h-10 w-full items-center justify-between rounded-md border border-main-border bg-surface px-3 py-2 text-sm placeholder:text-neutral-text hover:bg-accent focus:border-ring focus:outline-none focus:ring-1 focus:ring-ring disabled:cursor-not-allowed disabled:opacity-50 [&>span]:line-clamp-1",
        className,
      )}
      {...props}
    >
...
const SelectLabel = ({
  ...
  return (
    <SelectPrimitive.Label
      ...
      className={applyUnstyled(
        isUnstyled,
        "py-1.5 pl-2 pr-8 text-sm font-semibold",
        className,
      )}
      {...props}
    />
...
const SelectItem = ({
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={applyUnstyled(
        isUnstyled,
        "relative flex w-full cursor-default select-none items-center rounded-md py-1.5 pl-2 pr-8 text-sm outline-none focus:bg-accent focus:text-accent-text data-[disabled]:pointer-events-none data-[state=checked]:bg-primary/10 data-[state=checked]:text-primary data-[disabled]:opacity-50",
        className,
      )}
      {...props}
    >
